...
Most DHTs focus their efforts on preventing record loss due to churn. They rely on building topologies robust against random failures, under the assumption that because the overlay network is effectively a random mapping to the real world, that failures in the network will be independent events.
